...
/**
 * Status code indicating that an operation completed successfully.
 */
#define OK          0   /**< No error, operation was successful. */

/**
 * Status code indicating an invalid argument error.
 *
...
/**
 * Status code indicating an out-of-memory error.
 *
...
/**
 * Status code indicating an input/output error.
 *
...
/**
 * Status code indicating an invalid or non-existent path.
 *
...
/**
 * Status code indicating insufficient memory for file operations.
 *
...
/**
 * Status code indicating that the file system is not recognized or supported.
 *
...
/**
 * Status code indicating that the operation attempted to write to a read-only resource.
 *
...
/**
 * Status code indicating that a process slot is already taken.
 * 
...
/**
 * Status code indicating an invalid format.
 *
...
/**
 * Status code indicating that a file or directory does not exist.
 *
 * This error occurs when a file or directory specified in an operation does not exist.
 */
