...
global no_interrupt              ; Declare `no_interrupt` as a global symbol. This is a generic handler for unexpected or unhandled interrupts.
global enable_interrupt         ; Declare `enable_interrupt` as a global symbol. This function enables hardware interrupts.
global disable_interrupt        ; Declare `disable_interrupt` as a global symbol. This function disables hardware interrupts.
