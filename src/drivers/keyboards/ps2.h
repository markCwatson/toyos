 ...
 * The PS/2 controller is a hardware device used to interface with keyboards and mice, commonly found in older computer
 * systems. More information about the PS/2 keyboard can be found at https://wiki.osdev.org/PS/2_Keyboard.
 */
