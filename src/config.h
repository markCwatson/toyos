...
/**
 * Selector values for the kernel's code and data segments.
 * 
...
/**
 * Addresses for the heap and heap table.
 * 
...
/**
 * Maximum configuration values for file systems and descriptors.
 * 
...
/**
 * Configuration for the GDT (Global Descriptor Table).
 * 
...
/**
 * Configuration for the TSS (Task State Segment).
 */
...
/**
 * Configuration for process and program management.
 */
...
/**
 * Configuration for system calls.
 */
#define TOYOS_MAX_SYSCALLS  1024    /**< Maximum number of system calls. */

/**
 * Configuration for the keyboard buffer.
 */
